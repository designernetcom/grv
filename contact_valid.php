...
//print_r($_POST);exit();
 ...
 require_once "recaptchalib.php";
  ...
  // your secret key
  $secret = "6Ld4RyYiAAAAAJAUud2AzgE_UvWAWAHZ66o1SMWU";
...
if($error=="")
{
    ...
    require 'PHPMailer/PHPMailerAutoload.php';
       ...
       $mail->Password   = 'lorxmjvbuvbepuqp';

        $mail->SMTPSecure = 'ssl';                            // Enable TLS encryption, `ssl` also accepted
        $mail->Port = 465;                                    // TCP port to connect to
      //  $mail->Port = 587;                                    // TCP port to connect to

        $mail->From = 'shreeenterprises2003@gmail.com';
        $mail->FromName ='shreeenterprises2003@gmail.com';
        $mail->addAddress('shreeenterprises2003@gmail.com'); 
       ...
       // $mail->AddAttachment( $_FILES['file']['tmp_name'], $_FILES['file']['name'] );
        $mail->Subject  = 'Shree Enterprises GRV';
        $mail->isHTML(true);
